...
import {
    ...
    getAgentDetails, addAgent, updateAgent, deleteAgent, askCopilot, getRecentLogs } from "./api";
                  ...
                  <div>
                    ...
                    <div className="space-y-4 border-l-2 border-slate-200 ml-2 pl-4">
                      <div className="relative">
                        ...
                        <div className="text-sm font-semibold text-slate-800">Initial alert generated by EDR</div>
                      </div>
                      <div className="relative">
                        ...
                        <div className="text-sm font-semibold text-slate-800">Correlation Engine merged 3 related alerts</div>
                      </div>
                    </div>
                  </div>
